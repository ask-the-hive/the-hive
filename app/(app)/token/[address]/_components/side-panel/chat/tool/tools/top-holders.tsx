    ...
    <ToolCard
      ...
      result={{
        heading: (result: TokenPageTopHoldersResultType) =>
          result.body ? `Analyzed Top Holders` : `Failed to Analyze Top Holders`,
            ...
            <div className="flex flex-col gap-2">
              ...
              <StatsSection title="Exchange & Vesting">
                ...
                <StatItem
                  ...
                  suffix="%"
                />
                <StatItem label="# of Exchanges" value={result.body.numExchanges} />
                <StatItem label="# of Vesting Contracts" value={result.body.numVestingContracts} />
              </StatsSection>
              <StatsSection title="Distribution Analysis">
                <StatItem label="Concentration" value={result.body.concentrationLevel} />
                <StatItem label="Exchange Presence" value={result.body.exchangePresence} />
                <StatItem
