...
type TokenPageTradingActivityResultType =
  SolanaActionResult<TokenPageTradingActivityResultBodyType>;
...
const TradingActivity: React.FC<Props> = ({ tool }) => {
  return (
    <ToolCard
      ...
      result={{
        heading: (result: TokenPageTradingActivityResultType) =>
          result.body ? `Trading Activity Analysis` : `Failed to Analyze Trading Activity`,
        body: (result: TokenPageTradingActivityResultType) =>
          result.body ? (
