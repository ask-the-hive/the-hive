    ...
    >
      <div className="flex items-center space-x-2">
        ...
        <Label htmlFor="solana" className="flex items-center gap-1">
          <Image src="/chains/solana.svg" alt="Solana" width={16} height={16} className="w-4 h-4" />
          Solana
        </Label>
      </div>
      <div className="flex items-center space-x-2">
        ...
        <Label htmlFor="bsc" className="flex items-center gap-1">
          <Image src="/chains/bsc.svg" alt="BSC" width={16} height={16} className="w-4 h-4" />
          BSC
        </Label>
      </div>
      <div className="flex items-center space-x-2">
        ...
        <Label htmlFor="base" className="flex items-center gap-1">
          <Image src="/chains/base.svg" alt="Base" width={16} height={16} className="w-4 h-4" />
          Base
        </Label>
      </div>
    </RadioGroup>
