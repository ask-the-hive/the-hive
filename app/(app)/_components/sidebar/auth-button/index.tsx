                            ...
                            <>
                                ...
                                <DropdownMenuGroup>
                                    ...
                                    <DropdownMenuItem 
                                        onClick={() => {
                                            if (walletAddresses.base) {
                                                window.open(`https://www.brid.gg/base?amount=&originChainId=1&token=ETH`, '_blank');
                                            }
                                        }}
                                        className="gap-2"
                                    >
                                    ...
                                    <div className="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
                                        ...
                                        <div className="grid flex-1 text-left text-sm leading-tight">
                                            ...
                                            >
                                                ...
                                                {copied && (
                                                    <span className="text-xs text-brand-600 ml-1">Copied!</span>
                                                )}
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <Label htmlFor="base" className="flex items-center gap-1">
                                                ...
                                                Base
                                                {!walletAddresses.base && <AlertCircle className="w-3 h-3 text-yellow-500" />}
                                            </Label>
                                        </div>
                                    </RadioGroup>
                                </div>
