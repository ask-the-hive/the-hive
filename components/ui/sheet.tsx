...
const sheetVariants = cva(
  'fixed z-50 gap-8 bg-white p-8 shadow-dialog transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out dark:bg-neutral-900 border-neutral-200 dark:border-neutral-700',
  {
    variants: {
      side: {
