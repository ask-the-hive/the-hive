                        ...
                        <div className="md:hidden border-t border-neutral-200 dark:border-neutral-700">
                            <div className="py-2 px-4 space-y-2">
                                <a 
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="block px-3 py-2 text-sm font-medium rounded-md bg-neutral-100 text-neutral-700 hover:bg-neutral-200 dark:bg-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-600 transition-colors"
                                >
                                    Documentation
                                </a>
                                <div className="space-y-1">
                                    <div className="px-3 py-2 text-sm font-medium text-neutral-700 dark:text-neutral-200">
                                        Agents
                                    </div>
