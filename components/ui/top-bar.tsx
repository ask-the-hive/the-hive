...
import { ArrowLeftRight, ChartCandlestick, ContactRound, Brain, Beef, Wallet, Coins, Droplet, ChevronDown, Sun, Moon, Menu } from 'lucide-react'
                    ...
                    {isMobileMenuOpen && (
                        <div className="md:hidden border-t border-neutral-200 dark:border-neutral-700">
                            <div className="py-2 px-4 space-y-2">
                                ...
                                {/* Agents Section */}
                                <Collapsible open={openSection === 'agents'} onOpenChange={() => handleSectionToggle('agents')}>
                                    <CollapsibleTrigger className="w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors">
                                        <span>Agents</span>
                                        <ChevronDown className={`w-4 h-4 transition-transform duration-300 ${openSection === 'agents' ? 'rotate-180' : ''}`} />
                                    </CollapsibleTrigger>
                                    <AnimatePresence>
                                        {openSection === 'agents' && (
                                            <motion.div
                                ...
                                {/* Developers Section */}
                                <Collapsible open={openSection === 'developers'} onOpenChange={() => handleSectionToggle('developers')}>
                                    <CollapsibleTrigger className="w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors">
                                        <span>Developers</span>
                                        <ChevronDown className={`w-4 h-4 transition-transform duration-300 ${openSection === 'developers' ? 'rotate-180' : ''}`} />
                                    </CollapsibleTrigger>
                                    <AnimatePresence>
                                ...
                                {/* Socials Section */}
                                <Collapsible open={openSection === 'socials'} onOpenChange={() => handleSectionToggle('socials')}>
                                    <CollapsibleTrigger className="w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors">
                                        <span>Socials</span>
                                        <ChevronDown className={`w-4 h-4 transition-transform duration-300 ${openSection === 'socials' ? 'rotate-180' : ''}`} />
                                    </CollapsibleTrigger>
                                    <AnimatePresence>
                                        {openSection === 'socials' && (
                                            <motion.div
