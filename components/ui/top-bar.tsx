...
export default function TopBar() {
  ...
  return (
    <div className="fixed top-4 left-4 right-4 md:left-64 md:right-64 z-50">
        ...
        <div className="mx-auto px-2">
          <div className="flex items-center h-14">
            <div className="flex items-center">
              ...
              <div className="text-lg font-bold text-brand-600 font-sans">The Hive</div>
            </div>
            <div className="hidden md:flex flex-1 items-center justify-center gap-2">
              ...
              <div className="relative group">
                <button className="inline-flex items-center px-3 py-2 text-sm font-medium rounded-md bg-neutral-100 text-neutral-700 hover:bg-neutral-200 dark:bg-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-600 transition-colors">
                  Agents
            ...
            <div className="md:hidden border-t border-neutral-200 dark:border-neutral-700">
              <div className="py-2 px-4 space-y-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block px-3 py-2 text-sm font-medium rounded-md text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors"
                >
                  Documentation
                </a>
                ...
                <Collapsible
                  ...
                  onOpenChange={() => handleSectionToggle('agents')}
                >
                  <CollapsibleTrigger className="w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors">
                    <span>Agents</span>
                    <ChevronDown
                      className={`w-4 h-4 transition-transform duration-300 ${openSection === 'agents' ? 'rotate-180' : ''}`}
                    />
                  </CollapsibleTrigger>
                  <AnimatePresence>
                    {openSection === 'agents' && (
                      ...
                      >
                        <CollapsibleContent className="pl-4 space-y-1 mt-1">
                          <Link
                            href="/agents/trading"
                            className="block px-3 py-2 text-sm text-neutral-700 dark:text-neutral-100 hover:bg-neutral-100 dark:hover:bg-neutral-700 rounded-md"
                          >
                            <div className="flex items-center">
                              <ArrowLeftRight className="w-4 h-4 mr-2" />
                              Trading
                ...
                <Collapsible
                  ...
                  onOpenChange={() => handleSectionToggle('developers')}
                >
                  <CollapsibleTrigger className="w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors">
                    <span>Developers</span>
                    <ChevronDown
                      className={`w-4 h-4 transition-transform duration-300 ${openSection === 'developers' ? 'rotate-180' : ''}`}
                    />
                  </CollapsibleTrigger>
                  <AnimatePresence>
                ...
                <Collapsible
                  ...
                  onOpenChange={() => handleSectionToggle('socials')}
                >
                  <CollapsibleTrigger className="w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors">
                    <span>Socials</span>
                    <ChevronDown
                      className={`w-4 h-4 transition-transform duration-300 ${openSection === 'socials' ? 'rotate-180' : ''}`}
                    />
                  </CollapsibleTrigger>
                  <AnimatePresence>
                    {openSection === 'socials' && (
                ...
                <button
                  onClick={() => router.push('/chat')}
                  className="w-full mt-4 inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-brand-600 hover:bg-brand-700 transition-colors"
                >
                  Go to App
                </button>
