...
export const getKnowledgeFunction = async (args: GetKnowledgeArgumentsType): Promise<GetKnowledgeResultType> => {
  try {
    ...
    const { object } = await generateObject({
      ...
      system: `You are a knowledgeable assistant that provides information about Base Chain protocols, documentation, concepts, and tools. 
      ...
      "You can trade tokens on [Aerodrome](https://aerodrome.finance/) which is a popular DEX on Base."
      ...
      messages: [
        {
          role: "user",
          content: `Provide concise information about ${args.query} on Base Chain. 
    ...
    return {
      message: `Here's information about ${args.query} on Base Chain.`,
      body: {
    ...
    return {
      message: `Error retrieving information about ${args.query} on Base Chain.`,
      body: {
        information: `Failed to get information about ${args.query} on Base Chain. Please try again later.`,
        links: [
          {
